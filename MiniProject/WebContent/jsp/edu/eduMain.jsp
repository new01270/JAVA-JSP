			...
			<div id="main_slider" class="carousel slide" data-ride="carousel">
				<div class="carousel-inner">
					<div class="carousel-item active">
						<div class="container">
							<a class="category_click" href="/MiniProject/EduProgramming.do?programming=programming">
											...
											<div class="fuck">
												<div class="card" style="width: 18rem; height: 25rem"
													...
													<img class="card-img-top" src="images/${vo_p.eduImg}"
														alt="Card image cap">
													<div class="card-body">
														<h5 class="card-title" style="height: 60px">${vo_p.eduTitle }
														</h5>
								...
								<div class="row">
									<div class="row row-cols-1 row-cols-md-3 g-4">
										<c:forEach var="vo_n" items="${listNetwork }">
											<div class="fuck">
												<div class="card" style="width: 18rem; height: 25rem"
													onclick="location.href='/MiniProject/EduRead.do?id=${vo_n.eduNumber}'">
													<img class="card-img-top" src="images/${vo_n.eduImg}"
														alt="Card image cap">
													<div class="card-body">
														<h5 class="card-title" style="height: 60px">${vo_n.eduTitle }
														</h5>
								...
								<div class="row">
									<div class="row row-cols-1 row-cols-md-3 g-4">
										<c:forEach var="vo_d" items="${listDatabase }">
											<div class="fuck">
												<div class="card" style="width: 18rem; height: 25rem"
													onclick="location.href='/MiniProject/EduRead.do?id=${vo_d.eduNumber}'">
													<img class="card-img-top" src="images/${vo_d.eduImg}"
														alt="Card image cap">
													<div class="card-body">
														<h5 class="card-title" style="height: 60px">${vo_d.eduTitle }
														</h5>
								...
								<div class="row">
									<div class="row row-cols-1 row-cols-md-3 g-4">
										<c:forEach var="vo_s" items="${listskill }">
											<div class="fuck">
												<div class="card" style="width: 18rem; height: 25rem"
													onclick="location.href='/MiniProject/EduRead.do?id=${vo_s.eduNumber}'">
													<img class="card-img-top" src="images/${vo_s.eduImg}"
														alt="Card image cap">
													<div class="card-body">
														<h5 class="card-title" style="height: 60px">${vo_s.eduTitle }
														</h5>
								...
								<div class="row">
									<div class="row row-cols-1 row-cols-md-3 g-4">
										<c:forEach var="vo_c" items="${listCareer }">
											<div class="fuck">
												<div class="card" style="width: 18rem;height: 25rem"
													onclick="location.href='/MiniProject/EduRead.do?id=${vo_c.eduNumber}'">
													<img class="card-img-top" src="images/${vo_c.eduImg}"
														alt="Card image cap">
													<div class="card-body">
														<h5 class="card-title" style="height: 60px">${vo_c.eduTitle }
														</h5>
								...
								<div class="row">
									<div class="row row-cols-1 row-cols-md-3 g-4">
										<c:forEach var="vo_l" items="${listLife }">
											<div class="fuck">
												<div class="card" style="width: 18rem; height: 25rem"
													onclick="location.href='/MiniProject/EduRead.do?id=${vo_l.eduNumber}'">
													<img class="card-img-top" src="images/${vo_l.eduImg}"
														alt="Card image cap">
													<div class="card-body">
														<h5 class="card-title" style="height: 60px">${vo_l.eduTitle }
														</h5>
