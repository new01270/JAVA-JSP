...
<link rel="stylesheet" type="text/css"
	href="/MiniProject/css/bootstrap.min.css">
...
<link rel="stylesheet"
	href="/MiniProject/css/jquery.mCustomScrollbar.min.css">
<link rel="stylesheet"
					...
					<div class="containt_main">
						<div id="mySidenav" class="sidenav">
							<a href="javascript:void(0)" class="closebtn"
								...
								href="/MiniProject/HomeController.do">Home</a> <a
								href="/MiniProject/EduMain.do">EDU</a> <a
								href="/MiniProject/BoardList.do">COMMUNITY</a>
						</div>
						...
						<div class="dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
								...
								<a class="dropdown-item"
									...
									href="/MiniProject/EduCareer.do?career=career">커리어</a> <a
									class="dropdown-item" href="/MiniProject/EduLife.do?life=life">라이프</a>
							</div>
						</div>
						<div class="main">
								...
								<ul>
									<c:choose>
										<c:when test="${id eq null }">
											<li><a href="/MiniProject/jsp/member/signUp.jsp"> <i
													class="fa fa-user" aria-hidden="true"></i> <span
													class="padding_10">SIGNUP</span>
											</a></li>
											<li><a href="/MiniProject/jsp/member/login.jsp"> <i
													class="fa fa-user" aria-hidden="true"></i> <span
										...
										<c:otherwise>
											...
											<br>
											<li><a href="/MiniProject/jsp/member/myPage.jsp"> <i
													class="fa fa-user" aria-hidden="true"></i> <span
													class="padding_10">MYPAGE</span>
											</a></li>
											<li><a href="/MiniProject/Logout.do"> <i
													class="fa fa-user" aria-hidden="true"></i> <span
